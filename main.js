...
function addcard()
{
	...
	$(like).addClass("fa fa-thumbs-up upbtn").appendTo(votearea);
	var dislike=document.createElement("i");
	$(dislike).addClass("fa fa-thumbs-down downbtn").appendTo(votearea);

	$(".fa").css({"font-size":"30px","cursor":"pointer","user-select":"none"});
	$(like).css({"margin-left":"30%","margin-right":"20%"});
